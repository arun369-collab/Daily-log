...
import { Search, Box, AlertTriangle, Scale, FileSpreadsheet } from 'lucide-react';
          ...
          <div key={batch.batchNo} className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow overflow-hidden break-inside-avoid print:border-gray-300 print:shadow-none print:mb-4 print:inline-block print:w-[48%] print:mr-[1%] print:align-top">
            ...
            <div className="p-6">
              <div className="mb-4">
                ...
                <span className="inline-block mt-1 px-2 py-0.5 bg-blue-100 text-blue-700 text-xs rounded-full font-medium print:bg-gray-100 print:text-black print:border print:border-gray-300">
                  {batch.size}
                </span>
              </div>
